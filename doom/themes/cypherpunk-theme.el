...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyberpunk-orange-2 "#ff1493")
      (cyberpunk-orange-1 "#FF1493") ;; DarkOrange
      (cyberpunk-orange "#ffa500")
      (cyberpunk-yellow "#ff1493") ;; change this to modify function calls color
      ...
      (cyberpunk-blue-3 "#8a2be2")  ;; light blue
      (cyberpunk-blue-4 "#8a2be2")  ;; LightBlue2
...
;;                         "#1d2837"))
  ...
  (custom-theme-set-faces
   ...
   ;;; font lock
   `(font-lock-builtin-face ((,class (:foreground ,cyberpunk-green+3))))
   ...
   `(flyspell-incorrect ((,class (:foreground ,cyberpunk-gray :weight bold :underline t))))
